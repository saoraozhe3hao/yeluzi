    ...
    <div class="commodity-management-list"  v-loading="loading">
        ...
        <div class="list-table">
            <el-table ref="multipleTable" :data="table.data">
                ...
                <el-table-column prop="code" label="商品" width="100px"></el-table-column>
                <el-table-column prop="level" label="级别" width="100px"></el-table-column>
                <el-table-column prop="source" label="品牌" width="100px"></el-table-column>
        ...
        <el-dialog :title="addDialog.model.id ? '编辑商品':'添加商品'" :visible.sync="addDialog.visible" width="500px" :close-on-click-modal="false">
            <el-form :model="addDialog.model" ref="addForm" :rules="validate" label-width="100px">
                ...
                <el-form-item label="品牌：" prop="source">
                    ...
                    <i class="add-icon el-icon-circle-plus-outline" v-if="!addDialog.sources.length" @click="goto('/supplier-source')"></i>
                </el-form-item>
                <el-form-item label="油库：" prop="oilDepotId">
                    ...
                    <i class="add-icon el-icon-circle-plus-outline" v-if="!addDialog.depots.length" @click="goto('/supplier-tank')"></i>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            fetchList(){
                ...
                this.$axios({
                    method: "post",
                    url: this.$basePath + "/admin/goods/list",
                    params:{
                        length: 10,
            ...
            fetchTypes(){
                this.$axios({
                    method: "get",
                    url: this.$basePath + "/admin/goods/types"
                }).then((response) => {
                    response = response.data;
                    if(response.code == 0){
            ...
            fetchCodes(){
                this.$axios({
                    method: "get",
                    url: this.$basePath + "/admin/goods/codes",
                    params: {
            ...
            fetchLevels(){
                this.$axios({
                    method: "get",
                    url: this.$basePath + "/admin/goods/levels"
                }).then((response) => {
                    response = response.data;
                    if(response.code == 0){
            ...
            fetchSources(){
                this.$axios({
                    method: "get",
                    url: this.$basePath + "/admin/goods/sources"
                }).then((response) => {
                    response = response.data;
                    if(response.code == 0){
            ...
            fetchDepots(){
                this.$axios({
                    method: "get",
                    url: this.$basePath + "/admin/system/oildepotincompany"
                }).then((response) => {
                    response = response.data;
                    if(response.code == 0){
            ...
            submit(){
                ...
                this.$axios({
                    method: "post",
                    url: this.$basePath + (this.addDialog.model.id ? "/admin/goods/edit": "/admin/goods/save"),
