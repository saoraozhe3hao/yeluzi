<template>
    <div class="customer-verify-list" v-loading="loading">
        <div class="list-top">
            <span class="page-title">客户审核</span>
        ...
        <div class="list-table">
            <el-table ref="multipleTable" :data="table.data" @selection-change="selectionChange">
                ...
                <el-table-column prop="danSaleLicense" label="危化品经营执照代码"></el-table-column>
                <el-table-column label="危化品经营执照照片">
                    <template slot-scope="scope">
                        <img :src="scope.row.danSaleLicensePic + '!S70'" class="table-image"
                             @click="showCarousel(scope.row, 1)"/>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            fetchList() {
                ...
                this.$axios({
                    method: "post",
                    url: this.$basePath + "/admin/custom/service/audit/members",
                    params: {
                        length: 10,
